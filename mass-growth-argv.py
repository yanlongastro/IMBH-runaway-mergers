...
suffix = '%.0f'%(mass_cls)
title = r'$\mathcal{M}_c=%.2f M_{\odot}$'%(mass_cls)
...
plt.draw()
plt.title(title)
plt.savefig('massgrowth-'+suffix+'.pdf')
#plt.show()
...
ax.set_xlabel(r"$t[\mathrm{Myr}]$")
ax.set_ylabel(r"$\Delta \dot{M}_c[M_{\odot}/{\rm yr}]$")
ax.legend()
#plt.tight_layout()
plt.title(title)
plt.savefig('massgrowth-rate-'+suffix+'.pdf')
#plt.show()
...
ax.legend()
plt.title(title)
plt.savefig('meanmass-'+suffix+'.pdf')
#plt.show()
...
plt.title(title)
plt.savefig('meanradius-'+suffix+'.pdf')
#plt.show()
